...
import com.shvk.springbootmongodb.repository.PersonRepository;
...
public class PersonServiceImpl implements PersonService {
    ...
    @Override
    public String update(Person person, String personId) {
        ...
        if (personDetail.isPresent()) {
            ...
            update.set("addresses", person.getAddresses());
            mongoTemplate.updateFirst(Query.query(criteria), update, Person.class);
